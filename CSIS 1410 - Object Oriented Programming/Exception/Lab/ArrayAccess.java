      ...
      inputField.addActionListener( 
         new ActionListener()
         {
            public void actionPerformed( ActionEvent e )
            {
			   ...
			   {
					JOptionPane.showMessageDialog(null, "Please do not enter Duplicate values", "Invalid Input", JOptionPane.ERROR_MESSAGE);
			   }
         ...
         new ActionListener() 
         {
            public void actionPerformed( ActionEvent event )
            {
               /* Create a try block in which the application reads from 
				...
				{
					boolean found = false;
					String text = retrieveField1.getText();
					num = Integer.parseInt(text);
					for(int i = 0; i < array.length; i++)
					{
						if(array[i] == num)
      ...
      retrieveField2.addActionListener(
         new ActionListener() 
         {
            public void actionPerformed( ActionEvent event )
            {
               ...
               try
			   {
					String text = retrieveField2.getText();
					num = Integer.parseInt(text);
