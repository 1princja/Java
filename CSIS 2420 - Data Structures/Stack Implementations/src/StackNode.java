...
public class StackNode<E> {
  ...
  private StackNode<E> successor; // the link to this node's successor
   ...
   */
  public StackNode( E theElement, StackNode<E> theSuccessor ) {
   ...
   * @return this node's successor
   */
  public StackNode<E> getSuccessor() {
   ...
   */
  public void setSuccessor( StackNode<E> newSuccessor ) {
