...
public abstract class
  ...
  /**
   * Perform a preorder traversal of this tree applying the
   * Visitor to each node.
   * @param visitor the visitor to apply to each node of
   * this tree
   */
  ...
  /**
   * The recursive method for doing a preorder traversal of
   * the tree rooted at
   * node, applying visitor to each node of the tree.
   * @param node the node to visit; not null (no check done)
   * @param visitor the code to apply to the node; is not null
   *  (no check done)
   */
  protected void doPreOrderTraversal( BSTNode<E> node,
                                     Visitor<E> visitor ) 
  {
	  if ( node == null ) 
	  {
